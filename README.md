...
```
__OUTPUT GRAPH:__
<img width="959" height="539" alt="image" src="https://github.com/user-attachments/assets/3b0bf358-d4d7-4ff2-bb07-8d06f4679993" />

<img width="959" height="539" alt="image" src="https://github.com/user-attachments/assets/0d7a26ae-cdc2-4558-adb1-81fc86847ab5" />


__RESULT:__
The program to calculate the mean, variance, and cross-correlation using Scilab was successfully executed.
The obtained results and graph verify the correctness of the simulation.
